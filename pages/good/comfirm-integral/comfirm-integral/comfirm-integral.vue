    ...
    <view class="body">
      ...
      >
        <view
          class="h-person"
          v-if="address"
        >{{address.addressee + ' ' + address.mobile}}
        </view>
        <view
          class="h-address"
          v-if="address"
        >{{address.area_join.city_join.zh_name + address.area_join.zh_name + address.site}}</view>
        <view
          class="full"
          v-if="!address"
        >
...
<!--              <view class="g2">
      ...
      <view class="xiye">
        <van-checkbox :value="isWatch" style="margin-right: 20rpx;"></van-checkbox><text>我已阅读并同意</text><text
          style="color:#006CB7"
          @click="goArgreeMent"
        >《用户协议》</text>
      </view>
