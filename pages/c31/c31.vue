		...
		<view class="body">
			<view class="m1">
				<view class="m1-imgbox">
					<image src="" mode="" class="w100"></image>
				</view>
				<view class="m1-price">
					<view class="m1-p">
						¥980
				...
				<image src="../../static/c/c31close.png" mode="" class="m1-close"></image>
			</view>
			<view class="m2">
				<view class="m2-title">
					颜色
			...
			<view class="m4">
				...
				<view class="m4-numbox">
					<uniNumberBox :min="1" :max="9" :value="num" @change="bindChange"></uniNumberBox>
				</view>
			</view>
			<view class="m5">
				<view class="m5-title">
